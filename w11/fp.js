class FP { // Define a class named FP
  constructor(first, last, houseMembers, houseSize, foodChoice) { // Constructor function that initializes object properties
    ...
    this.foodPoints(); // Call the 'foodPoints' method to calculate food points
  ...
  foodPoints() { // Define a method named 'foodPoints' to calculate food choice points
    if (this.foodChoice === "meat daily") {
      this.foodPoints = 10;
    } else if (this.foodChoice === "meat few times a week") {
      this.foodPoints = 8;
