...
const renderTblBtn = (obj, index, data) => {
  ...
  btnEdit.addEventListener("click", (e) => {
    ...
    FORM.dishwasherUsage.value = obj.dishwasherUsage;
    FORM.washingMachineUsage.value = obj.washingMachineUsage;
    FORM.purchases.value = obj.purchases;
    //FORM.water.value = obj.waterConsumPoints.toString(); ********need to fix edit****
